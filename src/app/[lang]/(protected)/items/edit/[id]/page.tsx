...
import { Upload, X, MapPin, Navigation, Loader2 } from "lucide-react";
...
export default function ItemEditPage() {
  ...
  // Initialize location data from item
  const getInitialLocation = (): LocationData | null => {
    ...
    if (
      ...
      return {
        lat: item.location.coordinates[1], // latitude
        lng: item.location.coordinates[0], // longitude
  ...
  } = useLocation(getInitialLocation());
  ...
  useEffect(() => {
    ...
    if (item) {
      ...
      // Item not found, redirect to my-items
          ...
          <form onSubmit={handleSubmit}>
            <Card>
              <CardContent className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="price">Price per Day (Tk)</Label>
                    <Input
                      id="price"
                      type="number"
                      placeholder="4000"
                ...
                <div className="space-y-2">
                  ...
                  {!location && (
                    <p className="text-sm text-gray-500">
                      Click "Detect My Location" or "Select on Map" to set the
                      item location
                    </p>
                  )}
                </div>
